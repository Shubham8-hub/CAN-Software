...
public partial class App : Application
{
    ...
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddTransient<HomeRibbonpgViewModel>();
        services.AddTransient<HomeRibbonpgPage>();

        services.AddTransient<DisplayCanGridPgViewModel>();
        services.AddTransient<DisplayCanGridPgPage>();

        services.AddTransient<ListDetailspgViewModel>();
        services.AddTransient<ListDetailspgPage>();

        services.AddTransient<ContentGridpgViewModel>();
        services.AddTransient<ContentGridpgPage>();

        services.AddTransient<ContentGridpgDetailViewModel>();
        services.AddTransient<ContentGridpgDetailPage>();
